                ...
                <div className=''>
                    <div className='relative block text-center pt-[7.2rem]'>
                        ...
                        <div className='flex  font-shadows text-[#FFFFFF] text-[1.5rem] pl-[35.5rem] gap-4'>
                            ...
                            <p>/</p>
                            <p className=' transition-colors duration-500 ease-in-out hover:text-[#FF6C1E] cursor-pointer tracking-wider'>Donation Details</p>
                        </div>
                    </div>
                </div>
            </section>
            <div className='flex'>
                <div className='w-[50rem]  rounded-t-lg ml-[5.5rem] mt-[7.5rem]'>
                    <div className='flex'>
                        ...
                        <section class="bg-[url('./images/campaign-details-img-1.jpg')]  rounded-t-lg w-[48.4rem] h-[28.5rem] bg-cover bg-no-repeat"  >
                            <div className='font-rubik bg-[#FF9D00] w-[4.813rem] h-[2.25rem] text-white flex items-center justify-center ml-[42.2rem] mt-[26.2rem] rounded-t-lg'>Food</div>
                        </section>
                    </div>
                    <div className='w-[48.4rem] h-[8.688rem]  border-b-2 border-l-2 border-r-2 rounded-b-lg'>
                        <div className='flex'>
                            <div className='w-[43rem] h-[0.625rem] bg-[#EAE5E3] flex mt-[3rem] ml-[2.5rem] rounded-r-full'>
                    ...
                    <div className='mt-[3rem]'>
                        <ul className='items-center '>
                            ...
                            <li className='flex mt-4'>
                                <AiOutlineCheckCircle className='text-[2rem] text-[#FF6D12]' />
                                <p className='font-rubik text-[1.25rem] ml-[1rem]'>Suspe ndisse suscipit sagittis in leo.</p>
                            </li>
                            <li className='flex mt-4'>
                                <AiOutlineCheckCircle className='text-[2rem] text-[#FF6D12]' />
                                <p className='font-rubik text-[1.25rem] ml-[1rem]'>Entum estibulum dignissim lipsm posuere.</p>
                            </li>
                        </ul>
                    </div>
                    <div className='flex mt-[3.8rem]'>
                        <div className='w-[25rem] h-[16.063rem] '>
                            <img class="bg-[url('./images/summary-img-1.jpg')] w-[23.125rem] h-[100%] rounded-xl" alt='' />

                        </div>
                        <div className='w-[25rem] h-[16.063rem] '>

                            <img class="bg-[url('./images/summary-img-2.jpg')] w-[23.125rem] h-[100%] rounded-xl" alt='' />
                        </div>

                    </div>
                    <div className='mt-6 w-[48.125rem]'>
                        <p className='text-[1.125rem] font-semibold text-[#88858E] leading-loose mt-14'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. orem Ipsum has been the industry's standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
                    </div>
                    ...
                    <div className='flex '>
                        ...
                        <div className=" transition-colors duration-500 ease-in-out w-[13.438rem] bg-orange-500 h-[4.188rem]  mt-[2rem] flex rounded-full cursor-pointer hover:bg-black ">
                            <p className='text-[#FFFFFF] font-bold font-sans flex items-center pl-14 text-lg' >Donate Now</p>
                    ...
                    <div className='w-[48.125rem] h-[11.25rem]  bg-[#F7F4F2] rounded-lg mt-[2rem] flex'>
                        <div className='w-[4.375rem] h-[4.375rem] rounded-full bg-[#FF9D00] flex justify-center items-center mt-[3.4rem] ml-[3.5rem]'>
                        ...
                        <div className=" transition-colors duration-500 ease-in-out w-[8.125rem] bg-orange-500 h-[2.75rem] ml-[16rem] mt-[4.4rem] flex items-center justify-center rounded-full cursor-pointer hover:bg-black ">
                    ...
                    <div className='mt-10 w-[48.125rem]'>
                        ...
                        <div className='flex mt-[3rem]'>
                            <div className='w-[10.375rem] h-[10.375rem] rounded-full'>
                                <img class="bg-[url('./images/comment-1-1.png')]  w-[10.375rem] h-[10.375rem] rounded-full" alt='' />
                            </div>
                            <div className='ml-[2rem] w-[34.938rem] h-[10.375rem]'>

                                <p className='font-rubik  text-[1.25rem]  '>Kevin Matin</p>
                                <p className='mt-[2rem] leading-loose font-rubik text-[1rem] text-[#88858E]'>It has survived not only five centuries, but also the leap into electronic typesetting
                                    unchanged. It was popularised in the sheets containing lorem ipsum is simply free text.</p>

                                <div className=" mt-[-10rem] transition-colors duration-500 ease-in-out w-[6.188rem] bg-orange-500 h-[2.75rem] ml-[28.8rem]  flex items-center justify-center rounded-full cursor-pointer hover:bg-black ">
                                    <p className='text-[#FFFFFF] font-bold font-sans  text-[0.875rem]' >Reply</p>

                                </div>
                            </div>
                        </div>
                        <hr class="h-px my-3 bg-gray-200 border-0 mt-16 w-[100%]"></hr>
                        <div className='flex mt-[3rem]'>
                            <div className='w-[10.375rem] h-[10.375rem] rounded-full'>
                                <img class="bg-[url('./images/comment-1-2.png')]  w-[10.375rem] h-[10.375rem] rounded-full" alt='' />
                            </div>
                            <div className='ml-[2rem] w-[34.938rem] h-[10.375rem]'>
                        ...
                        <hr class="h-px my-3 bg-gray-200 border-0  w-[100%] mt-16"></hr>
                        <div className='mt-16 w-[48.125rem]'>
                        ...
                        <div className='w-[50rem] h-[39.938rem]'>
                            ...
                            <div className=" transition-colors duration-500 ease-in-out w-[16.188rem] bg-orange-500 h-[4.188rem] mt-[2rem] flex justify-center items-center rounded-full cursor-pointer hover:bg-black ">
                ...
                <div className='w-[23rem]  mt-[7.5rem] '>
                    <div className='bg-[#FF6D12] w-[100%] h-[30rem] rounded-lg'>
                        <div className='flex justify-center items-center pt-[3rem]'>
                            <img class="bg-[url('./images/organizer-img-1.png')] w-[13.063rem] h-[13.063rem] rounded-full" alt='' />
                        </div>
                        ...
                        <div className='flex justify-center items-center leading-loose'>
                            <div className='w-[15.625rem] h-[6.375rem]'>
                                <p className='font-rubik text-white text-[1.125rem] text-center'>It uses a dictionary of over lorem ipsum simply free text latin words,</p>
                            </div>
                        </div>
                    </div>
                    <div className='bg-[#F7F4F2] w-full h-[30rem] rounded-lg mt-[2rem]'>
                        <div>
                            <p className='font-rubik text-black text-[1.25rem] pt-[2.5rem] pl-[3rem] font-semibold'>Recent Donations</p>
                            <div className='flex pt-[1.5rem]  pl-[3rem]'>
                                <div>
                                    <img class="bg-[url('./images/recent-donation-img-1.jpg')] w-[5rem] h-[5.063rem] rounded-lg" alt='' />
                                </div>
                                <div className='pl-[1rem] leading-loose mt-[-0.5rem]'>
                                    ...
                                    <p className='text-[#88858E] font-rubik text-[0.875rem]  pl-1 pt-1'>3 hours ago</p>
                                    </div>
                            ...
                            <div className='flex pt-[1.5rem]  pl-[3rem]'>
                                <div>
                                    <img class="bg-[url('./images/recent-donation-img-2.jpg')] w-[5rem] h-[5.063rem] rounded-lg" alt='' />
                                </div>
                                <div className='pl-[1rem] leading-loose mt-[-0.5rem]'>
                                    <p className='font-rubik text-[1.125rem] text-[#FF6D12] '>$50</p>
                                    <div className='flex'>
                                    <p className='font-rubik text-[1rem] font-semibold'>Christine Eve</p>
                                    <p className='text-[#88858E] font-rubik text-[0.875rem]  pl-1 pt-1'>8 hours ago</p>
                                    </div>
                                    <p className='text-[#88858E] font-rubik text-[1rem]  '>God bless you dear</p>
                            ...
                            <div className='flex pt-[1.5rem]  pl-[3rem]'>
                                <div>
                                    <img class="bg-[url('./images/recent-donation-img-3.jpg')] w-[5rem] h-[5.063rem] rounded-lg" alt='' />
                                </div>
                                <div className='pl-[1rem] leading-loose mt-[-0.5rem]'>
                                    <p className='font-rubik text-[1.125rem] text-[#FF6D12] '>$10</p>
                                    <div className='flex'>
                                    <p className='font-rubik text-[1rem] font-semibold'>Mike Hardson</p>
                                    <p className='text-[#88858E] font-rubik text-[0.875rem]  pl-1 pt-1'>1 day ago</p>
                                    </div>
                                    <p className='text-[#88858E] font-rubik text-[1rem]  '>God bless you dear</p>
